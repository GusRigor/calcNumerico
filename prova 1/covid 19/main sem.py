...
k21 = deltaRecuperados / int(casos[len(casos)-2])
...
while t < 14:
    ...
    print(f't:{t} || PP:{x1:.0f} || C:{x2:.0f} || M:{x3:.0f}')
    ...
    print(f'K12: {k12}')
    k23 = (x3 - auxX3) / auxX2
    k21 = (1 - x2/auxX2 - k23 + k12*x1/auxX2) / auxX2
...
matplotlib.pyplot.ylabel('valores (C(t) e M(t)')
